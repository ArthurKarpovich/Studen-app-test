...
public class StudentAppTest {
    ...
    public void openStudentApp() {
        ...
        String name = dataFaker.lordOfTheRings().character();
        ...
        genderField.click();
        driverWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='ant-select-item-option-content']")));
        WebElement genderMale = driver.findElement(By.xpath("//div[@class='ant-select-item-option-content']"));
//        WebElement genderOther = driver.findElement(By.xpath("//div[@title='OTHER']"));
        genderMale.click();
        ...
        WebElement notificationDescription = driver.findElement(By.className("ant-notification-notice-message"));
        ...
        driverWait.until(ExpectedConditions.invisibilityOf(popUpCloseButton));
